...
public class Student{
    ...
    String Department;
    String University;
    float[][] GPA;  //row is for Year and coloumn is for Semister
    float CGPA;
    float gpa;
    String[] subjects;//string array for subjects of a term
    float[][][] credits; //First index for year 2nd is for semester & 3rd is for Subject number
    float[][][] grades; //First index for year 2nd is for semester & 3rd is for Subject number
    ...
    public Student(){
    	...
    	GPA=new float[4][2];//default initialization
    	CGPA=0.0;//default initialization
    	gpa=0.0;//default initialization
    	credits=new float[4][2][12];//default initialization
    	grades=new float[4][2][12];//default initialization
     ...
     */
    public float updateStudentById(int id){
    	Id = id;
    	...
    	for(int i=0;i<8;i++)
    	{
    		...
    		gpa= gpa+scan.nextFloat();//calculating total GPA
    	}
    	return gpa;
